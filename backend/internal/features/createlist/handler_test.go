...
func TestHandler(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			body:       CreateListRequest{Name: "My List", Creator: "Alice", Participants: []string{"Bob", "Charlie"}},
		...
		},
		{
			...
			method:     http.MethodPost,
			body:       CreateListRequest{Name: "My List", Creator: "Alice", Participants: []string{}},
			wantStatus: http.StatusCreated,
			wantListID: true,
		},
		{
			...
			method:     http.MethodPost,
			body:       CreateListRequest{Name: "My List", Creator: "Alice", Participants: []string{"Alice", "Bob"}},
			wantStatus: http.StatusCreated,
			wantListID: true,
		},
		{
			...
			method:         http.MethodPost,
			body:           CreateListRequest{Name: "My List", Creator: "", Participants: []string{"Bob"}},
		...
		},
		{
			name:           "missing name",
			method:         http.MethodPost,
			body:           CreateListRequest{Creator: "Alice", Participants: []string{"Bob"}},
			wantStatus:     http.StatusBadRequest,
			wantErrMessage: "List name is required",
		},
		{
		...
		},
		{
			...
			body:       CreateListRequest{Name: "My List", Creator: "Alice"},
			wantStatus: http.StatusMethodNotAllowed,
		},
		{
			name:           "duplicate participants",
			method:         http.MethodPost,
			body:           CreateListRequest{Name: "My List", Creator: "Alice", Participants: []string{"Bob", "Bob"}},
			wantStatus:     http.StatusBadRequest,
